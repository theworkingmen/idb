                ...
                let cityResults = data.records.Cities.map((city) => {
                    return (
                      <TallCard
                        name={city.name}
                        model='cities'
                        domain={city.image_link}
                        id={city.id}
                        highlight={searchprop.split(" ")}
												field1={city.county}
                        field2=""
                        field3={"Population: " + city.population}
                        key={city.id}>
                      </TallCard>)
                })
                    ...
                    return (
                      <TallCard
                        ...
                        highlight={searchprop.split(" ")}
												field1=""
                        field2=""
                        field3={"Avg Wage: " + major.average_wage}
                        key={major.id}>
                      </TallCard>)
                })
        ...
        if (this.state.results.length === 0) {
            ret = (
              <div className="container" style={{backgroundColor:"white"}}>
                <center><h1>No search results found</h1></center>
              </div>)
        } else {
          ret = (
            <div>
