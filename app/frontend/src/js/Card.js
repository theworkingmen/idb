		...
		return (
		    <Col xs={12} sm={4} md={4}>
				<Thumbnail>
					...
					{this.props.model==="colleges" ? (<Image src={`https://logo-core.clearbit.com/${this.props.domain}?size=500`} style={{width:"100%", height:"250px"}}/>) : (<Image src={this.props.domain} style={{width:"100%", height:"250px"}}/>)}
